            ...
            <div className="mb-6 rounded-lg px-4 py-3" style={{ backgroundColor: 'rgba(200, 230, 240, 0.65)', backdropFilter: 'blur(4px)' }}>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className={`block w-full text-left px-3 py-2 text-sm transition-colors rounded ${selectedCategory === 'all'
                ...
                {Object.entries(categories).map(([key, cat]) => (
                  <button
                    ...
                    className={`block w-full text-left px-3 py-2 text-sm transition-colors rounded ${selectedCategory === key
                      ? 'bg-white/40 text-gray-900 font-medium border-2 border-gray-700/60'
                      : 'text-gray-800 hover:bg-white/20'
                      }`}
                  >
        ...
        <div className="flex justify-center lg:justify-start px-2 lg:px-6 pb-3 lg:pb-6 pointer-events-none">
          ...
          >
            ...
            <div className="flex items-center gap-6 lg:gap-10 px-6 lg:px-12 py-5 lg:py-7 overflow-x-auto scrollbar-hide">
              {/* Menu Item 1 */}
              <Link to="/story" className="flex items-center gap-4 group shrink-0">
              ...
              {/* Menu Item 2 */}
              <Link to="/world" className="flex items-center gap-4 group shrink-0">
              ...
              {/* Menu Item 3 */}
              <Link to="/test" className="flex items-center gap-4 group shrink-0">
            ...
            <div className="fixed bottom-16 md:bottom-20 left-1/2 -translate-x-1/2 flex gap-1.5 md:gap-2 z-[60]">
              {[...Array(totalStorySections)].map((_, i) => (
                <button
                  ...
                  className={`w-1.5 h-1.5 md:w-2 md:h-2 rounded-full transition-all ${i === currentStorySection
                    ? 'bg-white w-6 md:w-8'
